...
let dictionary = {
  ...
  navTitle: {
    ...
    FBAcangku: ["FBA仓库", ""],
    FBAcangkudizhi: ["FBA仓库地址", ""],
    yunjiaxiangqing: ["运价详情", ""],
    gengduogongju: ["更多工具", ""],
    ...
    gangkoudaquan: ["港口大全", ""],
    jizhuangxiang: ["集装箱", ""],
    jizhuangxiangxiangqing: ["集装箱详情", ""],
    guojiadaima: ["国家代码", ""],
    chuansixiangqing: ["船司详情", ""],
    chuansibaike: ["船司百科", ""],
    lengcangwendu: ["冷藏温度 ", ""],
    weixianpin: ["危险品", ""],
    weixianpinxiangqing: ["危险品详情", ""],
    weixianpinliebiao: ["危险品列表", ""],
    HSbianma: ["HS编码", ""],
    HSbianmaxiangqing: ["HS 编码详情", ""],
    HSbianmaliebiao: ["HS编码列表", ""],
    gangkouliebiao: ["港口列表", ""],
    bumenkehu: ["部门客户", ""],
    FBAxiangqing: ["FBA详情", ""],
    FBAliebiao: ["FBA列表", ""],
    jijiancangkuxuanze: ["寄件仓库选择", ""],
    mudicangkuxuanze: ["目的仓库选择", ""],
    FBAtouchengchaxun: ["FBA头程查询", ""],
    lengdongxiangxiangqing: ["冷冻箱详情", ""],
    lengdongxiangchaxun: ["冷冻箱查询", ""],
    lengdongxiangliebiao: ["冷冻箱列表", ""],
    zhengxiangjinkouxiangqing: ["整箱进口详情", ""],
    zhengxiangjinkouliebiao: ["整箱进口列表", ""],
    zhengxiangjinkou: ["整箱进口", ""],
    jinkoupinxiangxiangqing: ["进口拼箱详情", ""],
    jinkoupinxiangliebiao: ["进口拼箱列表", ""],
    jinkoupinxiang: ["进口拼箱", ""],
    SPOTyunjia: ["SPOT运价", ""],
    tezhongxiangxiangqing: ["特种箱详情", ""],
    peixiangzhidao: ["配箱指导", ""],
    tezhongxiangliebiao: ["特种箱列表", ""],
    tezhongxiang: ["特种箱", ""],
    haiwaidailifeiyong: ["海外代理费用", ""],
    haiwaidailifeiyong: ["海外代理费用", ""],
    genzongxiangqing: ["跟踪详情", ""],
    genzongxiangqing: ["跟踪详情", ""],
    wodegenzongdingyue: ["我的跟踪订阅", ""],
    anlixiangqing: ["案例详情", ""],
    anli: ["案例", ""],
    gongyingshangxiangqing: ["供应商详情", ""],
    gongyingshangxinxi: ["供应商信息", ""],
    dingdangenzongxiangqing: ["订单跟踪详情", ""],
    dingdangenzongxiangqing: ["订单跟踪详情", ""],
  }
