...
let dictionary = {
  ...
  main: {
    ...
    dajianhuowuyunshuzhuanjia: ["全球OOG大件货物运输专家", "Online OOG logistics Freight"],
    puguiyunjia: ["普柜运价", "FCL"],
    quanqiuyunjiashishichaxun: ["全球运价实时查询", "Online FCL Freight"],
    lengdongguiyunjia: ["冷冻柜运价", "Reefer"],
    jingzhunyunjiashujudaquan: ["精准运价数据大全", "Online Reefer Freight"],
    jingdiananli: ["经典案例", "Success stories"],
    zhuanzhutezhongxiangwuliufuwu: [" - 专注特种箱物流服务", " "],
    anlijieshao: ["案例介绍", "Description"],
    xihuan: ["喜欢", "Like"],
    dianjizhelitianjiadaowodexiaoc: ["点击这里添加到我的小程序吧", "Click here to add to my minapp"],
    xiangmuxunpan: ["项目询价", "Project"],
  ...
  fcl: {
    ...
    paidui: ["排队", "Lineup"],
    bujie: ["不接", "NotPickUp"],
    tishixinxi: ["提示信息", "Remark"],
    hangcheng: ["航程", " "],
    zanweixuanzexiangxing: ["暂未选择箱型", "No containers"],
    xuanzexiangxing: ["选择箱型", "Select containers"],
    feiyongqingdan: ["费用清单", "Charge Details"],
  ...
  lcl: {
    ...
    renminbifeiyong: ["起运港费用", "Orign Surcharge"],
    mudigangshoufei: ["目的港收费", "Destination Surcharge"],
    ...
    kaihang: ["开航", "ETD"],
    jiageyouxiaoqi: ["价格有效期", "Validity Period"],
  },
  // 跟踪
  tracking: {
    billNo: ["提单号", "Bill No."],
  ...
  my: {
    ...
    myQuotation: ["我的报价单", "Quotes"],
    wodeyunjiadingyue: ["我的运价订阅", "Follows"],
    yunjiadingyue: ["运价订阅", "Follows"],
    genzongdingyue: ["跟踪订阅", "Trackings"],
    wodexiancang: ["我的现舱", "Spaces"],
    ...
    kehuleida: ["客户雷达", "Analysis"],
    kehugenzong: ["客户跟踪", "My Customers"],
    dingyuexiaoxi: ["订阅消息", "Subscribe Message"],
    bumenleida: ["部门雷达", "DP Analysis"],
    bumenkehu: ["部门客户", "DP Customers"],
    bossleida: ["BOSS雷达", "Overall Analysis"],
    gongsikehu: ["公司客户", "All Customers"],
    shuaxinhuancun: ["刷新缓存", "Refresh Cache"],
    yuyanshezhi: ["语言设置", "Language"],
    wodekefu: ["我的客服", "My Customer Service"],
    huokehaibao: ["获客海报", "Posters"],
    wodezhuanshukefu: ["我的专属客服", "Exclusive service"],
    banbengengxin: ["版本更新", "Versions"],
    wodezhuanshumingpian: ["我的专属名片", "My business card"],
    fenxiangmingpianranggengduoren: ["分享名片让更多人认识你", "Share your card"],
    ...
    dianzimingpian: ["电子名片", "My card"],
    xiaoxidingyue: ["消息订阅", "Notification"],
    haiwaidailifeiyong: ["海外代理费用", "Agent Freight"],
    keshangguanli: ["客商管理", "Customer Management"],
    wodegongyingshang: ["我的供应商", "My Suppliers"],
    qiehuanyuyan: ["切换语言", "Languages"],
  },
  // 运价订阅
  yunjiadingyue: {
    zhu: ["注", "Tip"],
  ...
  subMsg: {
    ...
    dangqiankejieshouxiaoxidiyu: ["当前可接收消息低于", "Less than 10 messages available"],
    yimianyingxiangninyukehude: ["请及时订阅,以免影响您与客户的", "Subscribe in time to maintain"],
    zhengchanghudong: ["正常互动", "interaction with customers"],
  },
  // 消息列表，聊天
  chat: {
  ...
  news: {
    ...
    jinruwodemingpian: ["进入我的名片", "My Card"],
  ...
  certi: {
    ...
    renzhengchenggong: ["认证成功", "Authentication success"],
  },
  // Air Freight
  air: {
  ...
  // 案例
  case: {
    fenxianganli: ["分享案例", "Share story"],
    zanwuanlixinxi: ["暂无案例信息", "No story information"],
  },
  // 铁路运价
  tieluyunjia: {
    qingxuanzeqiyundi: ["请选择起运地", "Please enter POL"],
    qingxuanzemudidi: ["请选择目的地", "Please enter POD"],
    qingshuruqiyundi: ["请输入起运地", "Please enter POL"],
    qingshurumudidi: ["请输入目的地", "Please enter POD"],
    tieluyunshufangshi: ["铁路", "RAIL"],
    qiyundi: ["起运地", "POL"],
    mudidi: ["目的地", "POD"],
    yunshufangshi: ["运输方式", "Transport"],
    chuguankou: ["出关口", "Exit"],
    xiangshu: ["箱属", "Owner"],
    haixiangdian: ["还箱点", "Return"],
    youxiaoriqiduan: ["有效日期", "Validity"],
  },
  // 询盘
  inquiry:{
    tianjiaxunpan: ["添加询盘", "Add a quote"],
    yihuifu: ["已回复", "Replied"],
    weihuifu: ["未回复", "unReplied"],
    xunpanshijian: ["询盘时间", "Request Time"],
    messageEmptyTop: ["您目前还没有发布项目询盘哦~", "You have not posted a quote"],
    messageEmptyBottom: ["点击上方添加快速咨询吧", "Click above to add a quick quote"],
  },
  // Toast Notice
  message: {
    ...
    savedSuccessfully: ['保存成功', 'Saved success'],
  ...
  onShareAppMessage: {
    ...
    lengdongxiangyunjiaxiangqing: ["冷冻箱运价详情", "Reefer Detail"],
    tezhongxiangxiangqing: ["特种箱运价详情", "OOG Detail"],
    jiejuefangan: ['解决方案', "Solutions"],
    tieluyunjiaxiangqing: ["铁路运价详情", "Railway Detail"],
  },
  // 底部菜单
  tabbar: {
    shouye: ["首页", "Home"],
  ...
  navTitle: {
    ...
    baojiadan: ["报价单", "Quotation"],
    yunjialiebiao: ["运价列表", "Fcl Freight List"],
    haiyunzhengxiang: ["海运整箱", "Fcl Freight"],
    xiugaihaiyunfei: ["修改海运费", "Modify Ocean Fee"],
    tianjiafeiyong: ["添加费用", "Add Charge"],
    xiugaifeiyong: ["修改费用", "Modify Charge"],
    genjin: ["跟进", "Follow"],
    wodexiaoxi: ["我的消息", "My Chats"],
    wode: ["我的", "Mine"],
    ...
    chuangongsichaxun: ["船公司查询", "Carrier Search"],
    tezhonggui: ["特种柜", "OOG"],
    tezhongguixiangqing: ["特种柜详情", "OOG Details"],
    tezhongguiliebiao: ["特种柜列表", "OOG List"],
    huowugenzong: ["货物跟踪", "Cargo Tracking"],
    ...
    FBAcangku: ["FBA仓库", "FBA Warehouse"],
    FBAcangkudizhi: ["FBA仓库地址", "FBA Warehouse Address"],
    yunjiaxiangqing: ["运价详情", "Fcl Freight Detail"],
    gengduogongju: ["更多工具", "More Tools"],
    dingdanxiangqing: ["订单详情", "Order Details"],
    qitafeiyong: ["其他币种", "Other Currency"],
    zixunxiangqing: ["资讯详情", "News Detail"],
    gangkoudaquan: ["港口大全", "Port Encyclopedia"],
    jizhuangxiang: ["集装箱", "Container"],
    jizhuangxiangxiangqing: ["集装箱详情", "Container Detail"],
    guojiadaima: ["国家代码", "Country Code"],
    chuansixiangqing: ["船司详情", "Ship Company Details"],
    chuansibaike: ["船司百科", "Shipping Encyclopedia"],
    lengcangwendu: ["冷藏温度 ", "Refrigerated Temperature"],
    weixianpin: ["危险品", "Dangerous Goods"],
    weixianpinxiangqing: ["危险品详情", "Dangerous Goods Details"],
    weixianpinliebiao: ["危险品列表", "Dangerous Goods List"],
    HSbianma: ["HS编码", "HSCode"],
    HSbianmaxiangqing: ["HS编码详情", "HSCode Detail"],
    HSbianmaliebiao: ["HS编码列表", "HSCode List"],
    gangkouliebiao: ["港口列表", "Port List"],
    bumenkehu: ["部门客户", "Department Customer"],
    FBAxiangqing: ["FBA详情", "FBA Detail"],
    FBAliebiao: ["FBA列表", "FBA List"],
    jijiancangkuxuanze: ["寄件仓库选择", "Start warehouse"],
    mudicangkuxuanze: ["目的仓库选择", "End warehouse"],
    FBAtouchengchaxun: ["FBA头程查询", "FBA Search"],
    lengdongxiangxiangqing: ["冷冻箱详情", "Reefer Freight Detail"],
    lengdongxiangchaxun: ["冷冻箱查询", "Reefer Freight"],
    lengdongxiangliebiao: ["冷冻箱列表", "Reefer Freight List"],
    zhengxiangjinkouxiangqing: ["整箱进口详情", "Fcl Import Detail"],
    zhengxiangjinkouliebiao: ["整箱进口列表", "Fcl Import List"],
    zhengxiangjinkou: ["整箱进口", "Fcl Import"],
    jinkoupinxiangxiangqing: ["进口拼箱详情", "Lcl Import Detail"],
    jinkoupinxiangliebiao: ["进口拼箱列表", "Lcl Import List"],
    jinkoupinxiang: ["进口拼箱", "Lcl Import"],
    SPOTyunjia: ["SPOT运价", "SPOT Freight"],
    tezhongxiangxiangqing: ["特种箱详情", "OOG Freight Detail"],
    peixiangzhidao: ["配箱指导", "Packing guide"],
    tezhongxiangliebiao: ["特种箱列表", "OOG Freight List"],
    tezhongxiang: ["特种箱", "OOG Freight"],
    haiwaidailifeiyong: ["海外代理费用", "Overseas agency fee"],
    genzongxiangqing: ["跟踪详情", "Tracking Detail"],
    wodegenzongdingyue: ["我的跟踪订阅", "My Tracking Subscription"],
    anlixiangqing: ["案例详情", "Story Detail"],
    anli: ["案例", "Success stories"],
    gongyingshangxiangqing: ["供应商详情", "Supplier Detail"],
    gongyingshangxinxi: ["供应商信息", "Supplier Info"],
    dingdangenzongxiangqing: ["订单跟踪详情", "Order Tracking Detail"],
    fenxiangxinwentupian: ["分享新闻图片", "Share News"],
    xiaoxidingyue: ["消息订阅", "Subscribe Message"],
    tieluyunjiachaxun: ["铁路运价查询", "Railway Freight"],
    tieluyunjialiebiao: ["铁路运价列表", "Railway Freight List"],
    tieluyunjiaxiangqing: ["铁路运价详情", "Railway Freight Detail"],
    qiyundi: ["起运地", "Port Search"],
    mudidi: ["目的地", "Port Search"],
    xiangmuxunpan:["项目询盘","Request a quote"]
  }
